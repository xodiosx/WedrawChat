...
if (currentuser !== null){
var uuser = currentuser.email;
draww.style.display = "block";
} else {
var uuser = "please Login or signup";
//alert ("not logged in");
...
//var user = f.currentUser;
p.a.analytics();function b(){return r.a.createElement(r.a.Fragment,null,r.a.createElement("button",{className:"sign-in",onClick:function(){location=("login/enlog.html");}},"please press here to Login first"),setTimeout(() => {
  console.log("WedrawChat.");
if (currentuser !== null){
